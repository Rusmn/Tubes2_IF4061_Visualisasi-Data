...
def layout(metric: str = "rokok_pct_of_gizi", region: str = "all") -> html.Div:
    ...
    if not active.empty and metric in active.columns:
        metric_avg = active[metric].mean()
    else:
    ...
    narrative = html.Div([
        ...
        html.P(
            ...
            f"Rata-rata stunting baduta: {stunting_avg:.1f}%."
        ),
        html.P(
    ...
    return html.Div([
        ...
        dbc.Row([
            ...
            dbc.Col(kpi_card("Stunting Baduta", pct(stunting_avg) if pd.notna(stunting_avg) else "N/A", "SKI 2023", "warning"), md=2),
        ...
        dbc.Row([
            dbc.Col([
                ...
                html.P(
                    ...
                    "dan stunting baduta (kanan). Data nasional SKI 2023.",
        ...
        html.Div([
            html.P(
                "Sisi kiri menunjukkan % perokok harian, sisi kanan % stunting baduta (0–23 bulan). "
